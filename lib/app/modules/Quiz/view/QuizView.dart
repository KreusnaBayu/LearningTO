...
import 'package:tryout/app/modules/Quiz/model/QuizModel.dart';
import 'package:tryout/app/modules/Score/view/ScoreView.dart';
import 'package:tryout/utils/global.color.dart';
import 'package:tryout/app/components/buttom_sheet.dart';
import 'package:tryout/app/components/quiz_widget.dart';
...
class _QuizPageState extends State<QuizPage> {
  ...
  void _finishQuiz() {
    showDialog(
      ...
      builder: (BuildContext context) {
        return AlertDialog(
          title: Text('Finish Quiz', style: TextStyle(color: Colors.black)),
          content: Text('Are you sure you want to finish the quiz?', style: TextStyle(color: Colors.black)),
          actions: [
            TextButton(
              onPressed: () {
            ...
            child: Column(
              ...
              children: [
                ...
                LinearProgressIndicator(
                  value: controller.currentQuestionId / 5,
          ...
          children: [
            ElevatedButton.icon(
              ...
              style: ElevatedButton.styleFrom(
                backgroundColor: controller.currentQuestionId == 1 ? Colors.grey : null,
              ),
            ),
            ElevatedButton.icon(
            ...
            ElevatedButton.icon(
              ...
              label: Text('', style: TextStyle(color: GlobalColors.mainColor)),
              style: ElevatedButton.styleFrom(
                backgroundColor: controller.currentQuestionId == 5 ? Colors.grey : null,
              ),
            ),
          ],
        ),
